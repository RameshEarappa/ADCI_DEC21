table 60002 "Purchase Quote Header"
{
    ...
    fields
    {
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Exist("Purchase Quote Lines" WHERE("Document Type" = FIELD("Document Type"),
        ...
        field(60; Amount; Decimal)
        {
            ...
            AutoFormatType = 1;
            CalcFormula = Sum("Purchase Quote Lines".Amount WHERE("Document Type" = FIELD("Document Type"),
                                                            "Document No." = FIELD("No.")));
            Caption = 'Amount';
            Editable = false;
            FieldClass = FlowField;
        ...
        field(61; "Amount Including VAT"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
            CalcFormula = Sum("Purchase Quote Lines"."Amount Including VAT" WHERE("Document Type" = FIELD("Document Type"),
                                                                            "Document No." = FIELD("No.")));
        ...
        {
            CalcFormula = Sum("Purchase Quote Lines"."A. Rcd. Not Inv. Ex. VAT (LCY)" WHERE("Document Type" = FIELD("Document Type"),
                                                                                      "Document No." = FIELD("No.")));
        ...
        {
            CalcFormula = Sum("Purchase Quote Lines"."Amt. Rcd. Not Invoiced (LCY)" WHERE("Document Type" = FIELD("Document Type"),
                                                                                    "Document No." = FIELD("No.")));
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum("Purchase Quote Lines"."Inv. Discount Amount" WHERE("Document No." = FIELD("No."),
        ...
        {
            CalcFormula = Min("Purchase Quote Lines"."Completely Received" WHERE("Document Type" = FIELD("Document Type"),
                                                                           "Document No." = FIELD("No."),
                                                                           Type = FILTER(<> " "),
                                                                           "Location Code" = FIELD("Location Filter")));
    ...
    trigger OnDelete()
    var
        RecLines: Record "Purchase Quote Lines";
    begin
        Clear(RecLines);
        RecLines.SetRange("Document Type", "Document Type"::Quote);
