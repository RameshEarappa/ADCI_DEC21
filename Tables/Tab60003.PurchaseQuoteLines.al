table 60003 "Purchase Quote Lines"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Document No.';
            TableRelation = "Purchase Quote Header"."No." WHERE("Document Type" = FIELD("Document Type"));
        }
        ...
        field(97; "Blanket Order No."; Code[20])
        {
            ...
            TableRelation = "Purchase Quote Header"."No." WHERE("Document Type" = CONST("Blanket Order"));
