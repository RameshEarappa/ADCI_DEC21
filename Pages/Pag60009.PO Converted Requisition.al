page 60009 "PO Converted Requisition"
{
    AdditionalSearchTerms = 'PR,Purch Requisition,Requisition,Oen Requisition,Quote,PO Created, PO Created Requisition';
    ApplicationArea = All;
    Caption = 'PO Converted Requisition';
    PageType = List;
    ...
    Editable = false;
    SourceTableView = sorting("No.") order(descending) where(Status = const("PO Created"));
