page 60004 "Purchase Quote converted To PO"
{

    Caption = 'Purchase Quote converted To PO';
    PageType = Document;
    ...
    SourceTableView = WHERE("Document Type" = FILTER(Quote), "PO Creation Status" = const("PO Created"));
    Editable = false;
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "Purchase Quotes Subform")
            {
                ApplicationArea = Suite;
                Editable = Rec."Buy-from Vendor No." <> '';
                Enabled = Rec."Buy-from Vendor No." <> '';
